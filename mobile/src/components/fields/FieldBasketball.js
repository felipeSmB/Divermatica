...
export default function FieldBasketball() {
    ...
    const threePointSide = 64;
    const threePointR = 72;
    ...
    return (
        <Svg viewBox={`0 0 ${W} ${H}`} width="100%" height="100%" preserveAspectRatio="xMidYMid slice">
            ...
            <Path
                d={`M ${cx - threePointSide} ${H} L ${cx - threePointSide} ${H - threePointCornerY} A ${threePointR} ${threePointR} 0 0 1 ${cx + threePointSide} ${H - threePointCornerY} L ${cx + threePointSide} ${H}`}
                stroke={LINEA} strokeWidth={2} fill="none"
            />
