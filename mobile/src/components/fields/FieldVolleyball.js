...
export default function FieldVolleyball() {
    ...
    return (
        <Svg viewBox={`0 0 ${W} ${H}`} width="100%" height="100%">
            ...
            {/* Center line and service zones */}
            <Line x1={W / 2} y1={6} x2={W / 2} y2={H - 6} stroke={LINE} strokeWidth={3} />
            <Line x1={6} y1={centerY - 36} x2={W - 6} y2={centerY - 36} stroke={LINE} strokeWidth={2} strokeDasharray="6,6" />
            <Line x1={6} y1={centerY + 36} x2={W - 6} y2={centerY + 36} stroke={LINE} strokeWidth={2} strokeDasharray="6,6" />

            {/* Attack lines (3m from center on each side) */}
            <Line x1={6 + 60} y1={6} x2={6 + 60} y2={H - 6} stroke={LINE} strokeWidth={2.5} />
            <Line x1={W - 6 - 60} y1={6} x2={W - 6 - 60} y2={H - 6} stroke={LINE} strokeWidth={2.5} />
